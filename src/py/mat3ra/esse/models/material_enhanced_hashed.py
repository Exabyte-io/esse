...
#   filename:  material_enhanced_hashed.json
#   version:   0.28.5
...
class BasisSchema(BaseModel):
    ...
    """
    constraints: List[AtomicConstraintSchema] = Field(..., title="atomic constraints schema")
    """
...
class MaterialEnhancedHashedSchema(BaseModel):
